Shader "Stencil/StencilRead"
{
    Properties
    {
        Color_1D641860("Color", Color) = (0, 0, 0, 0)
        [NoScaleOffset]Texture2D_26B12E7F("Texture2D", 2D) = "white" {}
    }
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            float4 Color_1D641860;
            CBUFFER_END
            TEXTURE2D(Texture2D_26B12E7F); SAMPLER(samplerTexture2D_26B12E7F); float4 Texture2D_26B12E7F_TexelSize;
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                float4 _Property_C6688FF9_Out_0 = Color_1D641860;
                surface.Albedo = (_Property_C6688FF9_Out_0.xyz);
